...
- **Clínica Médica**: Plataforma web para agendamento de consultas
- **Esplayer Lanches**: Site estático responsivo

### 🔷 WordPress
- **Loja Variedades - E-commerce de Roupas**: Loja virtual completa com WooCommerce
- **Blog Saúde Cachoeira do Sul**: Blog profissional sobre moda e saúde
- **Loja de Games - E-commerce de Games**: E-commerce completo com WooCommerce para venda de PCs, Notebooks e acessórios gamers
- **Fortunas em Foco**: Landing page sobre as pessoas mais ricas do Brasil e do mundo, com rankings atualizados e informações detalhadas sobre bilionários
