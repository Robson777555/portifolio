...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Create mailto link
        const mailtoLink = `mailto:robsonjobim96@hotmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Nome: ${name}\nEmail: ${email}\n\nMensagem:\n${message}`)}`;
...
function revealOnScroll() {
    const reveals = document.querySelectorAll('.about__container, .skills__container, .projects__content, .contact__container');
...
style.textContent = `
    .about__container, .skills__container, .projects__content, .contact__container {
        opacity: 0;
